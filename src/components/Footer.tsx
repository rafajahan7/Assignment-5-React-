    ...
    <footer className="border-t border-gray-100 bg-white mt-12">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-[8px] font-bold text-slate-800 uppercase">Product</h3>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 mt-3">
              ...
              <li><a href="#" className="text-[8px] text-gray-400 hover:text-pink-500">About</a></li>

              <li><a href="#" className="text-[8px] text-gray-400 hover:text-pink-500" >Contact</a></li>

              <li><a href="#" className="text-[8px] text-gray-400 hover:text-pink-500">Careers</a></li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 mt-3">
              ...
              <li><a href="#" className="text-[8px] text-gray-400 hover:text-pink-500">Privacy Policy</a></li>

              <li><a href="#"  className="text-[8px] text-gray-400 hover:text-pink-500">Terms of Service</a></li>
        ...
        <div className="border-t border-gray-100 mt-8 pt-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="text-[7px] text-gray-300 hover:text-gray-500" >Privacy</a>

            <a href="#" className="text-[7px] text-gray-300 hover:text-gray-500" >Terms</a>
